	...
	* --------------------------------------------------*/
    ...
    function init_de() {
        ...
        jQuery('.de-team-list').each(function () {
            var jElParent = jQuery(this), 
                h = jElParent.find("img:first()").css("height"),
                w = jElParent.find("img:first()").css("width");
            jElParent.css("height", h);
            jElParent.find("img").on('load', function () {
                var jEl = jQuery(this);
                jEl.parent().css("height", h);
                jEl.closest(".de-team-list").find('.team-desc').css({"width": w, "height": h, "top": h});
            }).each(function () {
